...
class minHeap
{
    private:
      ...
      public:						
        ...
        void heapify(int i); 
        BinaryTree remove(); 
// Returns the first Binary Tree of the min heap and then 
// Heapify the array of Binary trees in order of the frequencies of their root nodes.
  ...
  void print(); 
  // To print the frequencies of the root nodes of the array of Binary Trees
...
class HuffmanCode 
{
    private:
        BinaryTree HuffmanTree;    
                                                     //A Huffman Tree (a minimum weighted                                                                                                 ¬                                                                         external path length tree) 											                                    
